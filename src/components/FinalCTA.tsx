  ...
  <section className="bg-primary py-20">
    <div className="container text-center">
      <h2 className="font-display text-3xl md:text-4xl font-semibold text-primary-foreground mb-4">
        Ready to get structured guidance?
      </h2>
      <p className="text-primary-foreground/70 max-w-lg mx-auto mb-8">
        Get a personalised setup snapshot based on your activity, budget, timeline, and country context. No generic advice — just structured, reviewed recommendations.
      </p>
